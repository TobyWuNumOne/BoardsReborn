...
- Supabase local config, baseline migration, seed placeholder, generated Database types, and server API foundation helpers exist; product API handlers, login/session UI, and print-agent implementation are still pending.

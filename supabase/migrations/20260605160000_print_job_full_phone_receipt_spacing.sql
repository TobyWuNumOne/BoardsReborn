create or replace function public.build_print_phone_value(p_value text)
returns text
language sql
immutable
as $$
...
revoke execute on function public.build_print_phone_value(text) from public;
grant execute on function public.build_print_phone_value(text) to authenticated;
